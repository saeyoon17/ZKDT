...
void HashNodes_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void HashNodes_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
void ThreshComp_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ThreshComp_7_run(uint ctx_index,Circom_CalcWit* ctx);
void MiMCSponge_8_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MiMCSponge_8_run(uint ctx_index,Circom_CalcWit* ctx);
...
void ADTChecker_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ADTChecker_10_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_main_input_signal_no() {return 63;}

uint get_total_signal_no() {return 46930;}

uint get_number_of_components() {return 125;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 35054;}
...
Fr_sub(&expaux[3],&circuitConstants[0],&signalValues[mySignalStart + 4]); // line circom 51
Fr_mul(&expaux[1],&signalValues[mySignalStart + 4],&expaux[3]); // line circom 51
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 51
...
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 2]); // line circom 52
Fr_mul(&expaux[1],&expaux[2],&signalValues[mySignalStart + 4]); // line circom 52
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 52
// end load src
...
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 3]); // line circom 53
Fr_mul(&expaux[1],&expaux[2],&signalValues[mySignalStart + 4]); // line circom 53
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 3]); // line circom 53
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 0; i++){
...
ctx->componentMemory[coffset].templateName = "HashNodes";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[131]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[439]); // line circom 96
...
ctx->componentMemory[coffset].templateName = "ThreshComp";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 3;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
Fr_sub(&expaux[1],&circuitConstants[0],&signalValues[mySignalStart + 3]); // line circom 77
Fr_eq(&expaux[0],&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 77
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "hasher";
MiMCSponge_8_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 1770 ;
aux_cmp_num += 3;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MiMCSponge_8_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
ctx->componentMemory[coffset].templateName = "ADTChecker";
ctx->componentMemory[coffset].signalStart = soffset;
...
uint csoffset = mySignalStart+46119;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "hasher_class";
HashNodes_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4428 ;
aux_cmp_num += 7;
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "hasher_root";
...
uint csoffset = mySignalStart+6267;
uint aux_dimensions[1] = {10};
...
uint csoffset = mySignalStart+46169;
uint aux_dimensions[1] = {10};
for (uint i = 0; i < 10; i++) {
std::string new_cmp_name = "thresh_comp"+ctx->generate_position_array(aux_dimensions, 1, i);
ThreshComp_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 76 ;
aux_cmp_num += 4;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
HashNodes_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
ThreshComp_7_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[21]); // line circom 135
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 138
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 3];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 156
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 12)]].signalStart + 0]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
DualMux_0_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 54)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
HashNodes_3_run(mySubcomponents[cmp_index_ref],ctx);
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 22);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 0];
// load src
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 44)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
ThreshComp_7_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[19]); // line circom 172
if(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&signalValues[mySignalStart + 3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[11]].signalStart + 0]); // line circom 178
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 178. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 182
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[21]); // line circom 135
...
ADTChecker_10_create(1,0,ctx,"main",0);
ADTChecker_10_run(0,ctx);
}
